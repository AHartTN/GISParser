...
public class RawTigerDataEntities : DbContext
{
	public RawTigerDataEntities() : base("DefaultConnection")
	{
	}

	public RawTigerDataEntities(string connectionName) : base(connectionName)
	{
	}
